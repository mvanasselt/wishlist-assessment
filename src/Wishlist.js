...
export function Wishlist({ wishlistItems, onRemoveWishlistItem }) {
  ...
  return <div className="fixed right-0 top-0 w-[250px] h-full overflow-y-scroll overflow-x-hidden bg-neutral-100 flex flex-col items-center gap-3 shadow-md">Wishlist
